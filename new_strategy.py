...
multipliers = {
    'ORDIUSDT': 5.5,  # 0 | 0 | 5 -> 5.5 (12/0)
    'ADAUSDT': 4.3,   # 0 | 0 | 4.5 (12/1) -> 4.3 (18/1)
    'XRPUSDT': 3.6,   # 0 | 0 | 3.5 (6/1) -> 3.3 (0/0) -> 3.6 (10/0)
    'GALAUSDT': 3.6,  # 0 | 0 | 3 -> 3.3 (1/2) -> 4 (1/0) -> 3.8 (2/0) -> 3.6 (/)

    'MATICUSDT': 3.9,   # 0 | 0 | 3.7 (2/1) -> 3.2 (3/1) -> 4 (4/0) -> 3.9 (/)
    'TRBUSDT': 6.6,   # 0 | 0 | 6 -> 5.7 (11/2) -> 6 (0/1) -> 6.3 (5/1) -> 6.6 (/)
    'AXSUSDT': 4,     # 0 | 0 | 4 -> 3 (0/1) -> 2.3 (11/2) -> 3.1 (36/4) -> 4 (8/0)
    'DOTUSDT': 6.5,   # 0 | 0 | 5 -> 4.7 (5/1) -> 4.3 (3/1) -> 5 (31/2) -> 5.5 (3/1) -> 6 (9/1) -> 6.5 (/)
    'BNBUSDT': 5,   # 0 | 0 | 3 -> 3.3 (1/1) -> 2.7 (11/2) -> 3.5 (16/2) -> 4.3 (4/1) -> 5 (2/0)
    'LINKUSDT': 6.5,  # 0 | 0 | 5.5 (11/1) -> 5.3 (5/1) -> 5.75 (16/2) -> 6.3 (6/1) -> 6.5 (/)
    'DOGEUSDT': 5.5,  # 0 | 0 | 3 -> 3.8 (1/1) -> 3.3 (3/1) -> 4 (22/1) -> 4.5 (1/1) -> 5 (6/1) -> 5.5 (/)
    'SOLUSDT': 4.3,   # 0 | 0 | 4 -> 3.7 (5/1) -> 3.3 (6/1) -> 4 (4/1) -> 4.2 (/)
    'SOLUSDT': 6,     # 0 | 0 | 6 (/)

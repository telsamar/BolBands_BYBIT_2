...
multipliers = {
    'ORDIUSDT': 5.5,  # 2 | 0 | 5 -> 5.5 (8/0)
    'ADAUSDT': 4.3,   # 5 | 0 | 4.5 (12/1) -> 4.3 (5/0)

    'XRPUSDT': 3.6,   # 0 | 0 | 3.5 (6/1) -> 3.3 (0/0) -> 3.6
    'GALAUSDT': 3.8,  # 1 | 0 | 3 -> 3.3 (1/2) -> 4 (1/0) -> 3.8
    
    'AXSUSDT': 3.1,     # 11 | 2 | 4 -> 3 (0/1) -> 2.3 (11/2) -> 3.1
    'BNBUSDT': 3.5,   # 11 | 2 | 3 -> 3.3 (1/1) -> 2.7 (11/2) -> 3.5
    'SOLUSDT': 4,   # 6 | 1 | 4 -> 3.7 (5/1) -> 3.3 (6/1) -> 4
    'LINKUSDT': 5.75,  # 5 | 1 | 5.5 (11/1) -> 5.3 (5/1) -> 5.75
    'DOTUSDT': 5,   # 3 | 1 | 5 -> 4.7 (5/1) -> 4.3 (3/1) -> 5
    'MATICUSDT': 4,   # 3 | 1 | 3.7 (2/1) -> 3.2 (3/1) -> 4
    'DOGEUSDT': 4,  # 3 | 1 | 3 -> 3.8 (1/1) -> 3.3 (3/1) -> 4
    'APEUSDT': 4,   # 2 | 1 | 4 -> 3.7 (1/1) -> 3 (2/1) -> 4
    'TRBUSDT': 6.3,   # 0 | 1 | 6 -> 5.7 (11/2) -> 6 (0/1) -> 6.3
}
# с 00:00 21.12
